  ...
  <body>
    ...
    <div class="container overflow-hidden text-center">
      <div class="row gx-5">
        <div class="col">
          <div class="p-3">
            <img class="" src="../assets/image/Valorant_Logo.png" style="width: 18rem;">  
                <h5>Top-up Valorant Points</h5>
                <p>1. Pilih Nominal Top Up</p>
                <p>2. Pilih Pembayaran</p>
                <p>3. Selesaikan Pembayaran</p>
                <p>Lakukan Top-Up Voucher Valorant sekarang!<p>  
          </div>
        </div>
              ...
              <br><br><br><br>
                ...
                <div class="nominal">
                  ...
                  <div class="d-grid gap-2">
                    <input type="radio" class="btn-check" name="jml_bl" id="option1" value="500 VP" autocomplete="off">
                    <label class="btn btn-secondary" for="option1">500  VP</label>
                    <input type="radio" class="btn-check" name="jml_bl" id="option2" value="1000 VP" autocomplete="off">
                    <label class="btn btn-secondary" for="option2">1000 VP</label>
                    <input type="radio" class="btn-check" name="jml_bl" id="option3" value="1500 VP" autocomplete="off">
                    <label class="btn btn-secondary" for="option3">1500 VP</label>
                    <input type="radio" class="btn-check" name="jml_bl" id="option4" value="2000 VP" autocomplete="off">
                    <label class="btn btn-secondary" for="option4">2000 VP</label>
                    <input type="radio" class="btn-check" name="jml_bl" id="option5" value="2500 VP" autocomplete="off">
                    <label class="btn btn-secondary" for="option5">2500 VP</label>
                  </div>
                </div>   
                  <p><input type="hidden" name="nm_game" value="Valorant" /></p>        
                  <div class="nominal">
                    <h4>Bayar</h4>
                      <div class="d-grid gap-2">
