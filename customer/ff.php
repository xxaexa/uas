  ...
  <!-- Navbar  -->
    ...
    <div class="container overflow-hidden text-center">
      <div class="row gx-5">
        <div class="col">
          <div class="p-3">
            <img class="" src="../assets/image/ff.png" style="width: 18rem;">  
                <h5>Top-up FreeFire Points</h5>
                <p>1. Pilih Nominal Top Up</p>
                <p>2. Pilih Pembayaran</p>
                <p>3. Selesaikan Pembayaran</p>
                <p>Lakukan Top-Up Voucher FreeFire sekarang!<p>  
          </div>
        </div>
            ...
            <form method="post" action="">
              <br><br><br><br>
                ...
                <div class="nominal">
                  ...
                  <p><input type="hidden" name="nm_game" value="FreeFire" /></p>        
                  <div class="nominal">
                    <h4>Bayar</h4>
                      <div class="d-grid gap-2">
